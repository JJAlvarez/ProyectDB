...
if($usuario->updatePassword()){
    ...
    // tell the user
    echo json_encode(array("mensaje" => "Contraseña actualizada exitosamente.", "updated" => true));
}
...
// if unable to update the usuario, tell the user
    ...
    // tell the user
    echo json_encode(array("message" => "Error al actualizar la contraseña del usuario.", "updated" => false));
}
?>